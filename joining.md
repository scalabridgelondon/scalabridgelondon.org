...
* Join the [ScalaBridge discord][discord] and / or the [ScalaBridge slack][slack]. In the Slack we mainly use the `#london` channel. (If an invite link has expired please email {% email %} and we'll create a new one.)
